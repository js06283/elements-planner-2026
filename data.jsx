...
const LINEUP = [
  ...
  { day: "Friday",   stage: "earth", artist: "Its Murph",           genre: "House" },
...
function assignTimes() {
  ...
  return LINEUP.map((row) => {
    ...
    // Stable slug — never changes when lineup is reordered
    const id = "art-" + row.artist.toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/^-|-$/g, "");
    return {
      ...row,
      id,
      stage,
